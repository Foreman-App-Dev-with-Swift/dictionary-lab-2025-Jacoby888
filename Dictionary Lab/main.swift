...
var mappingIntergers : [Int : String]  = [ 1 : "one"]
 print(mappingIntergers)
...
print("The type of dictionary is an [Int : String] , the key is an integers and the value is a string. This dictionary is a short and type of dictionary. I created this type of dictionary so it can map the interger to its english word.")
...
var favoriteWords : [String : String] =  ["cumulative" : "increase of growing by acculation or successive addictions" , "mneomic" : "something intended to assist the memory" , "satire" : "the use of irony, sarcasm , riticole, or the like"]
      print(favoriteWords)
